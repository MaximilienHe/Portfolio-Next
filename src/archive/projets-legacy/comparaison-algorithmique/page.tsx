...
export default function Blog() {
	const breadcrumbBlogSansCms = [
		...
		{
			name: "Comparaison algorithmique",
			url: "https://maximilienherr.fr/projets/comparaison-algorithmique",
		},
	];
	return (
		<>
			<head>
				<title>Comparaison algorithmique - Maximilien Herr</title>
				<meta
					name="description"
					content="Découvrez mon projet de comparaison algorithmique, réalisé en C++."
				/>
				<link
					rel="canonical"
					href="https://maximilienherr.fr/projets/comparaison-algorithmique"
				/>
			</head>
