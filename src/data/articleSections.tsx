    ...
    articles: [
      {
        ...
        alt: "Illustration du test Samsung Galaxy S22 Ultra par Maximilien Herr sur DroidSoft",
      },
      {
        id: 2,
      ...
      },
      {
        ...
        alt: "Illustration de l'article Samsung Unpacked 2023 redige par Maximilien Herr",
      },
    ],
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        alt: "Illustration de l'article IFA 2022 Qualcomm redige par Maximilien Herr",
      },
      {
        id: 6,
        ...
        alt: "Illustration de la prise en main Lenovo ThinkPad X1 Fold par Maximilien Herr",
      },
    ],
  },
  {
    ...
    articles: [
      {
        ...
        alt: "Illustration de l'article IUT Informatique Graphique redige par Maximilien Herr",
      },
      {
        id: 8,
        ...
        imageKey: "Intro",
        alt: "Illustration de l'article Journees du numerique responsable par Maximilien Herr",
      },
      {
        id: 9,
        ...
        alt: "Illustration de l'article sur l'application DroidSoft redige par Maximilien Herr",
      }
    ],
  },
];
