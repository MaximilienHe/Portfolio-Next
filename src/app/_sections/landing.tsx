      ...
      <div className="container landing__inner">
        <div className="landing__copy">
          ...
          <h1>
            Maximilien Herr
            <br />
            Ingénieur Logiciel &amp; Journaliste Tech
          </h1>
          <p className="landing__lead">
            J&apos;architecture des produits et je les raconte avec une plume
            claire, pour que tech, produit et business avancent ensemble.
          </p>
        </div>
        ...
        <div className="landing__typeblock">
          ...
          <p className="landing__typehint">
            Deux mains, deux rythmes, un seul fil conducteur.
          </p>
        </div>
      </div>
    </section>
