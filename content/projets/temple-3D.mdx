...
date: "2022-06-30"
priority: 2
cover: "/images/Projects/generated/minimal-line/temple-3d.webp"
...
Nous étions 5 sur ce projet, ce qui représente donc près de 200 heures de travail, comprenant la modélisation, la création de textures, la création du jeu, mais aussi des réunions d'équipe. Les 5 membres du projet sont : [Eliot Bianchin](https://www.linkedin.com/in/eliot-bianchin/), [Lucas Chalmandrier](https://www.linkedin.com/in/lucas-chalmandrier/), [Léo Ricard--Lissard](https://www.linkedin.com/in/l%C3%A9o-ricard-lissard-b358a9250/), [Florian Mure](https://www.linkedin.com/in/florian-mure-9b335422b/), et moi-même.
...
![le confident SAE 3D](/images/Images/projects/le%20confident%20SAE%203D.jpg)
...
<div style={{ textAlign: "center" }}>
  <img src="/images/logos/3D & JV/Substance.png" alt="boules suspendues SAE 3D" />
</div>
...
Pour pouvoir discuter et poser des problèmes ou questionnements quelque part, nous avons utilisé Discord. Cela permettait de recenser les points de blocage, sur Discord ou Trello d'ailleurs, et les ressources du projet, comme le lien vers le Trello ou GitLab. Et bien évidemment, les discussions se faisaient aussi dans cet espace dédié.

#### Partage de fichiers

Nous travaillons sur de nombreux fichiers, qui plus est, lourds. Ainsi, il est important d'avoir un bon système pour partager les fichiers entre nous. Cette obligation d'avoir chacun une "casquette" différente, entre infographiste, gestion des textures et développeur, oblige d'avoir une bonne communication également. Donc, nous avons utilisé GitLab, avec une structure de dossiers, pour stocker nos fichiers de la meilleure des manières pour tout le monde.

![gitlab](/images/Images/projects/gitlab.png)
...
<div className="logos">
  <img src="/images/logos/3D & JV/3DSMax.png" alt="threeDsMaxLogo" className="logo" />
  <img src="/images/logos/3D & JV/Substance.png" alt="substancePainterLogo" className="logo" />
  <img src="/images/logos/3D & JV/UnrealEngine.png" alt="UnrealEngine logo" className="logo" />
